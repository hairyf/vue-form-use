...
export type FieldNamesMarkedBoolean<Values extends FieldValues> = DeepMap<DeepPartial<Values>, boolean>

export interface FormState<Values extends FieldValues = FieldValues> {
  isDirty: boolean
  isLoading: boolean
  isSubmitted: boolean
...
export interface FormStateProxy<Values extends FieldValues = FieldValues> {
  isDirty: boolean
  isValidating: boolean
 ...
 * ```
 */
export interface State<Values extends FieldValues> { form: FormState<Values>, fields: DeepMap<Values, FieldState> }
