 ...
 * See {@link Path}
 */
export type FieldPath<Values extends FieldValues> = Path<Values>
/**
 * Helper type for recursively constructing paths through a type.
 * This actually constructs the strings and recurses into nested
 * object types.
 ...
 * See {@link ArrayPath}
 */
export type FieldArrayPath<Values extends FieldValues> = ArrayPath<Values>
/**
 ...
 * See {@link PathValue}
 */
export type FieldPathValue<Values extends FieldValues, TFieldPath extends FieldPath<Values>> = PathValue<Values, TFieldPath>
/**
 * See {@link PathValue}
 */
export type FieldArrayPathValue<Values extends FieldValues, TFieldArrayPath extends FieldArrayPath<Values>> = PathValue<Values, TFieldArrayPath>
/**
 ...
 * ```
 */
export type FieldPathValues<Values extends FieldValues, TPath extends FieldPath<Values>[] | readonly FieldPath<Values>[]> = {} & {
  [K in keyof TPath]: FieldPathValue<Values, TPath[K] & FieldPath<Values>>;
}
/**
 ...
 * ```
 */
export type FieldPathByValue<Values extends FieldValues, TValue> = {
  [Key in FieldPath<Values>]: FieldPathValue<Values, Key> extends TValue ? Key : never;
}[FieldPath<Values>]
/**
 ...
 * ```
 */
export type FieldArrayPathByValue<Values extends FieldValues, TValue> = {
